...
class StepDefNavbarAllRole(CustomMethod, LocatorNavbar):
    ...
    def check_logout_is_visible(self):
        self.click_to(self.LOC_DROPDOWN_NAVBAR_PROFILE)
        self.is_web_element_visible(self.LOC_LOGOUT)
